...
(function($) {
    ...
    $.fn.treeview = function(settings) {
        var dfop =
            {
                 ...
                 */
                cbiconpath: "img/",
                icons: ["https://assetscdn.51zouchuqu.com/h5page/checkbox_0.png", "https://assetscdn.51zouchuqu.com/h5page/checkbox_1.png", "https://assetscdn.51zouchuqu.com/h5page/checkbox_2.png"],
                /**
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            if (deep == 1) {
                ht.push("<img class='bbit-tree-icon' src='https://assetscdn.51zouchuqu.com/h5page/s.gif'/>");
            }
            else if (deep > 1) {
                ht.push("<img class='bbit-tree-icon' src='https://assetscdn.51zouchuqu.com/h5page/s.gif'/>");
                for (var j = 1; j < deep; j++) {
                    ht.push("<img class='bbit-tree-elbow-line' src='https://assetscdn.51zouchuqu.com/h5page/s.gif'/>");
                }
            }
            ht.push("</span>");
            //img
            ...
            ht.push("<img class='bbit-tree-ec-icon ", cs.join(" "), "' src='https://assetscdn.51zouchuqu.com/h5page/s.gif'/>");
            ht.push("<img class='bbit-tree-node-icon' src='https://assetscdn.51zouchuqu.com/h5page/s.gif'/>");
            //checkbox
            if (dfop.showcheck && nd.showcheck) {
                if (nd.checkstate == null || nd.checkstate == undefined) {
                    nd.checkstate = 0;
                }
                ht.push("<img  id='", id, "_", nid, "_cb' class='bbit-tree-node-cb' src='", dfop.icons[nd.checkstate], "'/>");
            }
            //a
        ...
        function check(item, state, type) {
            ...
            if (item.render && pstate != item.checkstate) {
                ...
                var et = $("#" + id + "_" + nid + "_cb");
                if (et.length == 1) {
                    et.attr("src", dfop.icons[item.checkstate]);
                }
            }
        }
